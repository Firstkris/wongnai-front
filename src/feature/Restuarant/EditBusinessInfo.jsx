...
function EditBusinessInfo() {
        ...
        setOpeningHours(
            Object.entries(openingHours).reduce(
                (acc, day) => ({
                    ...acc,
                    [day[0]]: {
                        open: everydayTime?.open,
                        close: everydayTime?.close,
                        closed: false,
                    },
                }),
                {}
    ...
    const onChangeFacility = (e) => {
        setFacility((prv) => ({
            ...prv,
            [e.target.name]: { value: Boolean(+e.target.value) },
        }));
    };
                    ...
                    {!isEveryday ? (
                        ...
                        <>
                            <Input
                                type="time"
                                name={"open"}
                                label={"เลือกเวลาเปิดของทุกวัน"}
                                value={everydayTime.open}
                                onChange={hdlChangeEveryOpen}
                            />
                            <Input
                                type="time"
                                name={"close"}
                                label={"เลือกเวลาปิดของทุกวัน"}
                                value={everydayTime.close}
                                onChange={hdlChangeEveryOpen}
                            />
                        </>
                    )}
