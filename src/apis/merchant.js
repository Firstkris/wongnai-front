...
export const register = async (fromData) =>
  await axios.post("/merchant/register", fromData);
...
export const merchantCreateRestaurant = async (resData, openHours) =>
  axios.post("/merchant/create-restaurant", { resData, openHours });
